...
public class ReportEngine {
    ...
    void checkReports(MonthlyReport monthlyReport, YearlyReport yearlyReport) {
        if(yearlyReport.yearLoaded&&monthlyReport.monthLoaded)
        {
        ...
        else if(!yearlyReport.yearLoaded&&!monthlyReport.monthLoaded)
        {
            System.out.println("Сначала необходимо загрузить данные по годам и месяцам");

        }
        else if(!yearlyReport.yearLoaded){
            System.out.println("Сначала необходимо загрузить данные за год");
        }
        else if(!monthlyReport.monthLoaded){
            System.out.println("Сначала необходимо загрузить данные по месяцам");
        }
